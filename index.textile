...
h2. full index of pages

There is some major duplication -- we're consolidating the documentation into the single gh-pages site within the repo.
...
* "Usage notes & Getting Started":usage.textile
...
** "Part 1, setup":UsingWukong-part1-setup.html
** "Part 2, scraping":UsingWukong-part2-scraping.html
** "Part 3, parsing":UsingWukong-part2-parsing.html
* Hadoop notes
