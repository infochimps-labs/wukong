...
%default UNDIRECTED_PAGELINKS  's3n://bigdata.chimpy.us/data/results/wikipedia/full/undirected_pagelinks' -- all edges in the pagelink graph
...
neighbors            = FOREACH  spokes               GENERATE (((node_a == $HUB1) OR (node_a == $HUB2)) ? node_b : node_a) AS node;
