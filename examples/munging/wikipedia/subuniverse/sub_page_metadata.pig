...
%default PAGE_METADATA         '$ROOT/data/results/wikipedia/full/page_metadata' -- metadata for all pages in the wikipedia corpus
...
sub_page_metadata_filtered = FILTER sub_page_metadata_unfiltered BY namespace == 0;
sub_page_metadata = FOREACH sub_page_metadata_filtered GENERATE
