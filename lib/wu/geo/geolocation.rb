...
module Wu
  module Geo
    ...
    #
    # A set of methods for converting among
    #
    # * longitude / latitude
    # * quadtile id
    # * tileserver pixel coordinates
    ...
    #
    module Geolocation
      module_function # call methods as eg Wu::Geo::Geolocation.tile_xy_to_quadkey or, if included in class, on self as private methods
      ...
      # The "quadkey of a point" methods use this zoom level; ZL=18 is about a
      # city block (140m / 500ft at mid latitudes)
      POINT_ZL          = 18
      ...
      # Convert latitude in degrees to integer tile x,y coordinates at given zoom level
      def point_to_quadkey(longitude, latitude)
